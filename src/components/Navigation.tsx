...
export default function Navigation() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-14">
            ...
            {userSpecies.length > 0 && (
              <div className="flex items-center gap-2 bg-green-800 rounded-lg px-3 py-1.5 shrink-0">
      ...
      <div className="fixed bottom-0 inset-x-0 z-50 bg-white border-t border-gray-200 flex md:hidden">
        {NAV_ITEMS.map((item) => {
          const isActive = pathname === item.href;
          return (
            <Link
